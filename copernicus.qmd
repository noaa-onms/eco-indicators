...
```{r}
librarian::shelf(
  dplyr, glue, here, leaflet, mapview, ncdf4, readr, reticulate, sf, stringr, terra, tidyr,
  quiet = T)
...
for (i in 1:length(ncs)){ # i=17
  ...
  if (file.exists(results_csv)){
    read_csv(results_csv) |> 
      bind_rows(d) |> 
      distinct(nms, dataset, var, time, stat) |> 
